...
alumns = [
    {
    	...
    	"status":"active",
    	"gendre":"h",
    	"bio":"Es el representante de Guatemala. No solo tiene un gran talento musical, tambien es un gran deportista. A pesar de su corta edad, es un padre responsable y amoroso. Es jovial, distraido e inquieto. Su pasatiempo principal es convivir con su familia, amigos y disfrutar de su gran pasion: la musica. </bio>",
    	}, 
    	{
    	"name":"Gabriela", 
    	"id":"gabriela",
